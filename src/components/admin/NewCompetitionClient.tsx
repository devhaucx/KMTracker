...
import { createCompetition } from '@/app/(admin)/admin/competitions/actions'
...
export default function NewCompetitionClient() {
  ...
  const [status, setStatus] = useState<'draft' | 'registration' | 'active'>('draft')
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await createCompetition({
      name, inviteCode, description, startDate, endDate, registrationDeadline,
      status, sportRules: convertedRules,
    })
