...
import { MOCK_DEPARTMENTS, MOCK_DEPARTMENT_LEADERBOARD } from '@/lib/mock/data'
...
export default function AdminDepartmentsPage() {
  const initialDepartments: DepartmentItem[] = MOCK_DEPARTMENTS.map((dept) => {
    const lbEntry = MOCK_DEPARTMENT_LEADERBOARD.find((l) => l.department_id === dept.id)
    return {
      ...dept,
      memberCount: lbEntry ? lbEntry.participant_count : 10,
    }
  })
